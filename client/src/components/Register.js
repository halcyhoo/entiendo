...
export default class Register extends Component {
  ...
  handleSumbit = (e) =>{
    ...
    axios.post(Config.server+"register", {email: email, password: password})
    .then((response)=>{
      toast.update(toastId, {type: "success", autoClose: true, render: "Success! Please wait"})
          ...
          <div className="row">
            <div className={this.props.singleColumn?"col-sm-12":"col-sm-6"}>
              <div className="form-group">
                <input type="email" className="form-control labeled" id="register-email" name="email" placeholder="Email" />
            ...
            <div className={this.props.singleColumn?"col-sm-12":"col-sm-6"}>
              <div className="form-group">
                <input type="password" className="form-control labeled" id="register-password" name="password" placeholder="Password" />
